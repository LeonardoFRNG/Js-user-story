export function renderHome() { //exportamos la función que renderiza el contenido de la página de inicio
    return `
  ...
  <div class="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
    ...
    <nav class="hidden items-center gap-3 md:flex">
      <a class="rounded-full px-4 py-2 text-sm font-semibold text-slate-600 hover:bg-blue-50 hover:text-blue-700"
        data-link href="/">Home</a>
      <a class="rounded-full px-4 py-2 text-sm font-semibold text-slate-600 hover:bg-blue-50 hover:text-blue-700"
        data-link href="/login">Login</a>
      <a class="rounded-full bg-blue-600 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-500"
...
<main class="mx-auto max-w-6xl px-6 py-14">
  <section class="grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
    <div>
      <p class="inline-flex rounded-full bg-blue-100 px-4 py-2 text-sm font-semibold text-blue-700">Organiza tu trabajo
        con calma</p>
      ...
      <div class="mt-8 flex flex-col gap-3 sm:flex-row">
        <a class="inline-flex items-center justify-center rounded-2xl bg-blue-600 px-6 py-3 text-sm font-bold text-white shadow-lg shadow-blue-200 hover:bg-blue-500"
          data-link href="/login">Iniciar sesion</a>
        <a class="inline-flex items-center justify-center rounded-2xl border border-blue-200 bg-white px-6 py-3 text-sm font-bold text-blue-700 hover:bg-blue-50"
          data-link href="/register">Crear cuenta</a>
      </div>
    </div>
    ...
    <section class="rounded-[2rem] border border-blue-100 bg-white p-8 shadow-xl shadow-blue-100/70">
      ...
      <div class="mt-6 grid gap-4 sm:grid-cols-2">
        <a class="rounded-3xl bg-sky-50 p-5 hover:bg-sky-100" data-link href="/dashboard">
        ...
        <a class="rounded-3xl bg-sky-50 p-5 hover:bg-sky-100" data-link href="/tasks">
          <p class="text-sm font-semibold text-blue-600">Mis tareas</p>
          <p class="mt-2 text-sm text-slate-600">CRUD principal del usuario.</p>
        </a>
        <a class="rounded-3xl bg-sky-50 p-5 hover:bg-sky-100" data-link href="/profile">
        ...
        <a class="rounded-3xl bg-sky-50 p-5 hover:bg-sky-100" data-link href="/admin">
